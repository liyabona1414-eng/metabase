...
1. In Metabase, open a command palette with Ctrl/Cmd+K, type "New embed" and select "new embed" command. This will open the interactive izard that you can use to set up your embed.
